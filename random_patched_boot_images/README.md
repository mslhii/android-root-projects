...
Update: there will be no more updates because there have been no more exploits available for a long time, even older exploits such as mtkclient and mtk-su have long been patched out of all newer phones with MediaTek chipsets. Maybe one day there will be another exploit like mtkclient and potentially also penumbra (if there are an
